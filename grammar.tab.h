...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_ANDROID_PROGRESS = 284,      /* T_ANDROID_PROGRESS  */
    T_ANDROID_MAX = 285,           /* T_ANDROID_MAX  */
    T_COMMENT_OPEN = 286,          /* T_COMMENT_OPEN  */
    T_COMMENT_CLOSE = 287,         /* T_COMMENT_CLOSE  */
    T_STRING = 288,                /* T_STRING  */
    T_STRING_SINGLE_QUOTE = 289,   /* T_STRING_SINGLE_QUOTE  */
    T_POSITIVE_INTEGER = 290,      /* T_POSITIVE_INTEGER  */
    T_SLASH_END_TAG = 291,         /* T_SLASH_END_TAG  */
    T_STRING_DQ_SPACE = 292,       /* T_STRING_DQ_SPACE  */
    T_DOT = 293,                   /* T_DOT  */
    T_COMMA = 295,                 /* T_COMMA  */
    T_ASSIGN = 297,                /* T_ASSIGN  */
    T_COLON = 299,                 /* ":"  */
    T_LBRACK = 300,                /* T_LBRACK  */
    T_RBRACK = 302,                /* T_RBRACK  */
    T_SLASH = 304,                 /* "/"  */
    T_EXCLAMATION = 305,           /* "!"  */
    T_DASH = 306,                  /* "-"  */
    T_LBRACES = 307,               /* "{"  */
